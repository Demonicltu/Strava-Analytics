...
3️⃣  ---
4️⃣  💡 TIPS (AI coaching: cadence, pacing, recovery)
5️⃣  ---
...
- **Private**: compact stats → coaching tips → zones → HR/cadence/climbing analysis → readiness tables → 7-day plan → 6-month baselines
...
A: **`balanced`** (default). It gives followers the key performance narrative (score, metrics, verdict, segments) while keeping your personal recovery/readiness private.

**Q: Which mode is best for personal training log?**
A: **`strict`**. Public gets the full narrative (score, stats, verdict, segments) without the raw data tables. Private gets a structured deep log: key stats → tips → zones → HR/cadence/climbing/pacing → readiness → recommendation → historical baselines.
